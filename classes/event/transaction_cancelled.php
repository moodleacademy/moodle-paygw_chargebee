...
/**
 * This event is triggered whenever the payment transaction is cancelled
 *
...
class transaction_cancelled extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventtransactioncancelled', 'paygw_chargebee');
    }
    ...
    public function get_description() {
        return "The payment transaction for user with id '$this->userid' was cancelled for '{$this->other['component']}' with itemid '{$this->other['itemid']}'.";
    }
