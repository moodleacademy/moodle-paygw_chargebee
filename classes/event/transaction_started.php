...
/**
 * This event is triggered whenever a payment transaction starts
 *
...
class transaction_started extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventtransactionstarted', 'paygw_chargebee');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' started a payment transaction for '{$this->other['component']}' with itemid '{$this->other['itemid']}'.";
    }
